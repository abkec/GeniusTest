package com.example.test.tutor.forum
...
class ForumContentTutor : AppCompatActivity() {
    ...
    class ForumViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        init {
            ...
            itemView!!.setOnClickListener {
                ...
                val listItems = arrayOf("This answer is useful", "This answer is not useful", "Delete this comment")
