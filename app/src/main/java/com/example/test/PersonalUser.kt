...
import kotlinx.android.synthetic.main.activity_personal_user.*
...
class PersonalUser : AppCompatActivity() {
    ...
    override fun onStart() {
       ...
       //mUserReference.child(mUser.uid).removeValue() --> delete account
        ...
        submit.setOnClickListener {
            ...
            Toast.makeText(this@PersonalUser, "Details Updated", Toast.LENGTH_SHORT).show()
            dialog.show()
            finish()
